...
GO
if object_id('[dbo].[API_GetNextLevelApprovers_Plan]') is null
	EXEC ('CREATE PROCEDURE [dbo].[API_GetNextLevelApprovers_Plan] as select 1')
GO

ALTER PROCEDURE [dbo].[API_GetNextLevelApprovers_Plan]
...
begin
    ...
    -- Kiểm tra xem cấp này có bị Admin ghim cứng không
