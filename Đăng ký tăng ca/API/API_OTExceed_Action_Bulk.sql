if object_id('[dbo].[API_OTExceed_Action_Bulk]') is null
	EXEC ('CREATE PROCEDURE [dbo].[API_OTExceed_Action_Bulk] as select 1')
GO

ALTER PROCEDURE [dbo].[API_OTExceed_Action_Bulk]
...
BEGIN
    ...
    BEGIN
        ...
        IF @value <> ''
        BEGIN
            EXEC [dbo].[API_OTExceed_Action] @Identity_ID = @value, @LoginID = @LoginID, @Action = @Action, @Remark = @Remark;
        END
